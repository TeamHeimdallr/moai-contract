...
forge create \
  ...
  --constructor-args 0x1D6B655289328a1083EcD70170692002dBED1aBD 0x2Cfc4e04a825286e2B54b1281De1D2AD43EB254F {"name":"ComposableStablePoolFactory","version":5,"deployment":"20230711-composable-stable-pool-v5"} {"name":"ComposableStablePool","version":5,"deployment":"20230711-composable-stable-pool-v5"}
