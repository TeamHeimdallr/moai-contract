...
async function main() {
  ...
  console.log("deploying Pool Info Aggregator");
  try {
    ...
    const factory = await ethers.getContractFactory("PoolInfoAggregator");
    ...
    newFileContents["PoolInfoAggregator"] = ret.address;
    historiesFileContents[`PoolInfoAggregator-${timestamp}`] = ret.address;
