...
async function main() {
  ...
  try {
    ...
    const factory = await ethers.getContractFactory("WeightedPoolFactory");
    ...
    newFileContents["WeightedPoolFactory"] = ret.address;
    historiesFileContents[`WeightedPoolFactory-${timestamp}`] = ret.address;
